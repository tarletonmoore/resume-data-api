...
exp = Experience.create!(start_date: "1/1/23", job: "instructor", company: "actualize", details: "teaches stuff", student_id: 2)

ed = Education.create!(start_date: "12/30/22", end_date: "12/31/22", degree: "computer science", university_name: "Syracuse", details: "masters", student_id: 2)

skill = Skill.create!(skill_name: "ruby", student_id: 2)

cap = Capstone.create!(name: "sf parking ticket", description: "how to not get a parking ticket", url: "briansapp.com", student_id: 2)
